...
import com.monkeyham.elendilmod.worldgen.biome.surface.ModSurfaceRules;
...
public class ModDimensions {
    public static final ResourceKey<LevelStem> MIDDLEEARTHDIM_KEY = ResourceKey.create(Registries.LEVEL_STEM,
            ResourceLocation.fromNamespaceAndPath(ElendilMod.MODID, "middleearthdim"));
    ...
    public static final ResourceKey<DimensionType> MIDDLEEARTH_DIM_TYPE = ResourceKey.create(Registries.DIMENSION_TYPE,
            ResourceLocation.fromNamespaceAndPath(ElendilMod.MODID, "middleearthdim_type"));
