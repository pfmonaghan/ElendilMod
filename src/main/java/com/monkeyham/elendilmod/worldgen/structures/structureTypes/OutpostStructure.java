package com.monkeyham.elendilmod.worldgen.structures.structureTypes;
...
public class OutpostStructure extends Structure {
    ...
    public static final MapCodec<OutpostStructure> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(OutpostStructure.settingsCodec(instance),
    ...
    public OutpostStructure(Structure.StructureSettings config,
    ...
    protected Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        ...
        if(!OutpostStructure.extraSpawnChecks(context)) {
