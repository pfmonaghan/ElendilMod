...
//
//            int i = ((GondorInfantry) entity).getAttackAnimationTick();
//                if (i > 0) {
//                    this.ArmR.xRot = -2.0F + 1.5F * Mth.triangleWave((float) i - partialTick, 10.0F);
//                    this.ArmL.xRot = -2.0F + 1.5F * Mth.triangleWave((float) i - partialTick, 10.0F);
//                }
//
//
//            //AnimationUtils.swingWeaponDown(this.ArmR, this.ArmL, entity, this.attackTime, i - partialTick);
//
//        }
