...
public class OrcInfantryModel<T extends OrcInfantryEntity> extends HierarchicalModel<T> implements ArmedModel {
    ...
    public void setupAnim(OrcInfantryEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        {
            AnimationUtils.swingWeaponDown(this.ArmR, this.ArmL, (Mob) entity, this.attackTime, ageInTicks);
        }
    }
