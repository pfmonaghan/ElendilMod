...
public class OrcHumanoidInfantryEntity extends OrcAbstract {
    ...
    public OrcHumanoidInfantryEntity(EntityType<? extends OrcHumanoidInfantryEntity> entityType, Level level) {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource random, DifficultyInstance difficulty) {
        ...
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ModItems.MORDOR_HELMET_1.get()));
        this.setItemSlot(EquipmentSlot.CHEST, new ItemStack(ModItems.MORDOR_CHESTPLATE_1.get()));
