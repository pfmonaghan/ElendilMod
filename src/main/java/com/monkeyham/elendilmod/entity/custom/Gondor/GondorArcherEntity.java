...
public class GondorArcherEntity extends HumanAbstract implements RangedAttackMob {
    public GondorArcherEntity(EntityType<? extends PathfinderMob> entityType, Level level) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, (new HurtByTargetGoal(this, new Class[]{HumanAbstract.class})).setAlertOthers(new Class[0]));
    ...
    public HumanArmPose getArmPose() {
        ...
        {
            return HumanArmPose.BOW_AND_ARROW;
        }
    ...
    public void performRangedAttack(LivingEntity target, float distanceFactor) {
        ...
        abstractarrow.shoot(d0, d1 + d3 * (double)0.2F, d2, 1.6F, (float)(0));// Original 14 - this.level().getDifficulty().getId() * 4
        this.playSound(ModSoundEvents.GOOD_BOW_SHOOT.get(), 1.0F, 1.0F / (this.getRandom().nextFloat() * 0.4F + 0.8F));
